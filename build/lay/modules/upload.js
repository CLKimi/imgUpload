...
;layui.define("layer", function (e) {
    ...
    s.prototype.init = function () {
        ...
        return a("#" + n)[0] || r.append(u), s.each(function (r, s) {
            ...
            t.unwrap || (u = '<div class="layui-box layui-upload-button">' + u + '<span class="layui-upload-icon">' + (s.attr("lay-title") || t.title || "本地" + (o[l] || "上传")) + "</span></div>"), u = a(u), t.unwrap || u.on("dragover", function (e) {
        ...
        if (u) {
            ...
            var c = a("#" + n), f = setInterval(function () {
                ...
                try {
                    ...
                    //t.msg("上传接口存在跨域", r), clearInterval(f)   //先注释
                }
                if (a) {
